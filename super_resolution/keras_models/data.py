...
# #orig resize
# for imagename in tqdm(os.listdir(trainhrpath)):
...
# for imagename in tqdm(os.listdir(validhrpath)):
...
# our resize without shit
# # for resize use (720,480) as size
...
#todo
"""
create function to resize images
label data correctly as x-y pairs
delete caches
loss
"""